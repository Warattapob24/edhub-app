"""Consolidate all Google auth and course columns

Revision ID: 64c25761fd53
Revises: 7a57f17885e0
Create Date: 2025-11-14 08:33:55.973123
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['head_role_id'], ['role.id'], name='fk_admin_dept_head_role'),
    sa.ForeignKeyConstraint(['member_role_id'], ['role.id'], name='fk_admin_dept_member_role'),
    sa.ForeignKeyConstraint(['vice_director_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['vice_role_id'], ['role.id'], name='fk_admin_dept_vice_role'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    ...
    sa.ForeignKeyConstraint(['academic_year_id'], ['academic_year.id'], name='fk_classroom_academic_year'),
    sa.ForeignKeyConstraint(['grade_level_id'], ['grade_level.id'], name='fk_classroom_grade_level'),
    sa.ForeignKeyConstraint(['program_id'], ['program.id'], name='fk_classroom_program'),
    sa.ForeignKeyConstraint(['room_id'], ['room.id'], name='fk_classroom_room'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['grade_level_id'], ['grade_level.id'], name='fk_curriculum_grade_level'),
    sa.ForeignKeyConstraint(['program_id'], ['program.id'], name='fk_curriculum_program'),
    sa.ForeignKeyConstraint(['semester_id'], ['semester.id'], name='fk_curriculum_semester'),
    sa.ForeignKeyConstraint(['subject_id'], ['subject.id'], name='fk_curriculum_subject'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('semester_id', 'grade_level_id', 'program_id', 'subject_id', name='_semester_grade_program_subject_uc')
    )
    ...
    sa.Column('submitted_at', sa.DateTime(), nullable=True),
    sa.Column('midterm_google_form_id', sa.String(length=255), nullable=True),
    sa.Column('midterm_google_sheet_id', sa.String(length=255), nullable=True),
    sa.Column('final_google_form_id', sa.String(length=255), nullable=True),
    sa.Column('final_google_sheet_id', sa.String(length=255), nullable=True),
    sa.ForeignKeyConstraint(['classroom_id'], ['classroom.id'], ),
    ...
    sa.Column('google_form_id', sa.String(length=255), nullable=True),
    ...
    sa.Column('topic_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['subunit_id'], ['sub_unit.id'], name='fk_subunit_topics_subunit'),
    sa.ForeignKeyConstraint(['topic_id'], ['assessment_topic.id'], name='fk_subunit_topics_topic'),
